...
#set save directory
parser.add_argument('--checkpoint_dir', dest='checkpoint_dir',  default='/data/private/checkpoint', help='check point dir')
...
parser.add_argument('--print_freq', dest='print_freq', type=int, default=10, help='print_freq (iterations)')
